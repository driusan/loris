LorisBVLApp = React.createClass({displayName: 'LorisBVLApp',
    ...
    render: function() {
        if (this.state.CandID === undefined || this.state.CandID === false) {
            return React.createElement(CandidateListApp, {onPSCIDClicked: this.selectCandidate})
        }
        if (this.state.Visit === undefined || this.state.Visit === false) {
            return React.createElement(CandidateVisitList, {CandID: this.state.CandID, CandData: this.state.CandData, onVisitClicked: this.selectVisit})
        }
        return React.createElement(CandidateVisitInstrumentList, {CandID: this.state.CandID, CandData: this.state.CandData, Visit: this.state.Visit, VisitData: this.state.VisitData, VisitInstruments: this.state.VisitInstruments})
    }
});
